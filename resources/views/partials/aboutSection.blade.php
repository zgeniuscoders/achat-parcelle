<section class="container mx-auto lg:px-40 px-10 my-20 relative">

    <ol class="relative border-s border-gray-200 dark:border-gray-700">
        <li class="mb-10 ms-6">
            <span
                class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:text-green-900">
            ...
            <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Flowbite
                Application UI v2.0.0 <span
                    class="bg-blue-100 text-green-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:text-green-900 dark:text-green-300 ms-3">Latest</span>
            </h3>
