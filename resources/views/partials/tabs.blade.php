...
{{-- 
    <li role="presentation" class="flex-auto text-center">
        <a href="{{ route('property.index') }}?type=percel"
            ...
            data-twe-toggle="pill" data-twe-target="percel" role="tab" aria-controls="tabs-profile01"
            aria-selected="false">Parcelle</a>
    </li>
    <li role="presentation" class="flex-auto text-center">
        <a href="#tabs-messages01"
            ...
            data-twe-toggle="pill" data-twe-target="#tabs-messages01" role="tab" aria-controls="tabs-messages01"
            aria-selected="false">Maisons</a>
    </li> --}}
</ul>
